...
1. Open with a short lead that names what {brand.display_name} actually does — enumerating ONLY the services present in the SERVICES context for this client, never the generic restoration list (a dedicated mold company must never be described as handling water, fire, storm, biohazard, or reconstruction work) — in language a stressed homeowner skims. Avoid corporate openers.
