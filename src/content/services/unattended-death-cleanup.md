...
priority: 5.4
plan_hash: "e633ae5b93360935"
generated_at: "2026-07-15T05:27:45.343436+00:00"
manual_override: false
internal_links: ["/services/", "/contact/", "/service-areas/auburn-wa/unattended-death-cleanup/", "/service-areas/bellevue-wa/unattended-death-cleanup/", "/service-areas/bremerton-wa/unattended-death-cleanup/", "/service-areas/everett-wa/unattended-death-cleanup/", "/service-areas/gig-harbor-wa/unattended-death-cleanup/", "/service-areas/kent-wa/unattended-death-cleanup/", "/service-areas/kirkland-wa/unattended-death-cleanup/", "/service-areas/port-orchard-wa/unattended-death-cleanup/", "/service-areas/redmond-wa/unattended-death-cleanup/", "/service-areas/renton-wa/unattended-death-cleanup/", "/service-areas/seattle-wa/unattended-death-cleanup/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Services", "url": "/services/"}, {"name": "Unattended Death Cleanup"}]
faq: [{"question": "How do I know whether the subfloor or walls need to be removed, or just cleaned?", "answer": "That determination is made on-site during the initial assessment using ATP testing and visual inspection of material porosity and saturation depth. Hardwood and laminate flooring almost always require removal because decomposition fluids wick through seams into the OSB or plywood below. Drywall at floor level is evaluated case by case. We document the findings before any demolition begins so the scope is clear to you and your insurance carrier."}, {"question": "What certifications and licenses are required to legally handle and transport biohazardous waste in Washington State?", "answer": "In Washington, biohazardous waste must be transported under a regulated waste manifest in compliance with Washington State Department of Ecology rules and DOT 49 CFR Part 173 for infectious substances. The remediation firm must follow OSHA Bloodborne Pathogen Standard (29 CFR 1910.1030) protocols, and technicians must have documented bloodborne pathogen training. National Restoration Construction meets these requirements and provides a copy of the waste manifest as part of the remediation documentation package."}, {"question": "Why does odor sometimes return weeks after a cleanup company says the job is done?", "answer": "Odor returns when the source material \u2014 not just the surface \u2014 wasn't fully addressed. Volatile fatty acids and sulfur compounds from decomposition penetrate porous substrates like concrete, OSB, and wall cavities. If those materials weren't removed or treated with enzymatic cleaners that break down organic compounds at a molecular level, the smell off-gasses back into the living space over time. Masking sprays and deodorizing foggers don't solve this; they delay it. Proper odor removal after death requires enzymatic treatment of the substrate combined with hydroxyl or ozone treatment of the air volume."}, {"question": "Can the property be re-occupied or re-listed after remediation, and what documentation is needed?", "answer": "Yes \u2014 once post-remediation verification confirms contamination levels meet clearance standards, the space is safe for re-occupancy or re-listing. For estate proceedings or property sales, we provide written documentation of the remediation scope, the waste manifest, and clearance verification. Some real estate transactions and estate attorneys specifically request this paperwork; having it ready avoids delays in closing or re-listing the property."}, {"question": "How discreet is the process \u2014 will neighbors or building residents know what's happening?", "answer": "Our team arrives in unmarked vehicles and does not use signage or branded materials visible from the street. Technicians wear plain protective gear rather than logoed suits during entry and exit. For multi-unit buildings, we coordinate timing with property managers to minimize visibility in common areas. We understand that discretion matters to families and landlords alike, and we treat it as a standard part of the job, not an add-on."}]
...
## What separates a thorough response from an incomplete one
...
Our team is based in Federal Way and responds throughout King and Pierce Counties, including Tacoma, Auburn, Kent, Renton, Burien, Des Moines, Puyallup, and surrounding communities. City-specific pages for each area link back to this page for full service details.
