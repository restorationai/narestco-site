---
archetype: "blog-post"
title: "What Does Homeowners Insurance Cover and Not Cover"
h1: "What Does Homeowners Insurance Cover and Not Cover"
meta_description: "Most homeowners policies cover sudden, accidental damage but exclude gradual deterioration, flooding, and neglect. Here's exactly what's covered, what's excluded, and how to document a claim that holds up."
primary_keyword: "what does homeowners insurance cover and not cover"
...
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Blog", "url": "/blog/"}, {"name": "What Does Homeowners Insurance Cover and Not Cover"}]
faq: [{"question": "Does homeowners insurance cover water damage from a burst pipe?", "answer": "Yes, in most cases. A burst pipe is a sudden, accidental loss \u2014 the type of event standard HO-3 policies are designed to cover. The insurer will typically pay for water extraction, structural drying, and repair of damaged materials. The exception is if the pipe burst due to long-term neglect or freezing that the insurer argues was preventable. Document the cause and timeline carefully."}, {"question": "Does homeowners insurance cover water damage from rain or flooding?", "answer": "It depends on how the water entered. Rain damage caused by a storm opening up your roof or breaking a window is generally covered \u2014 that's a windstorm peril. Rain that enters through a pre-existing leak or poor maintenance is not. Flooding from rising groundwater, storm surge, or overflowing bodies of water is excluded from standard policies entirely and requires a separate flood insurance policy through the NFIP or a private insurer."}, {"question": "Does homeowners insurance cover mold remediation?", "answer": "Only when the mold is directly tied to a covered peril. If mold grew because of a covered burst pipe that was reported and mitigated promptly, most policies will include mold remediation in the claim scope. Many policies also have a mold sublimit \u2014 often $5,000 to $10,000 \u2014 even for covered events. Mold from chronic humidity, slow leaks, or deferred maintenance is typically excluded."}, {"question": "What is the average insurance payout for water damage?", "answer": "It varies widely by scope. A single-room supply-line burst with no structural involvement might settle for $3,000 to $8,000. A multi-room loss with subfloor damage, Category 2 water, and reconstruction can reach $20,000 to $50,000. The key variables are water category (1, 2, or 3 per IICRC S500), drying class, square footage affected, and whether the loss reached wall cavities or structural materials."}, {"question": "Should I file a homeowners insurance claim for water damage?", "answer": "File if the damage clearly exceeds your deductible by a meaningful margin, involves contamination (Category 2 or 3 water), or has reached structural materials like subfloor, wall framing, or insulation. Don't file for minor cosmetic damage where the net payout after your deductible is small \u2014 claims can affect your premium at renewal. When in doubt, get a written damage assessment from an IICRC-certified contractor before deciding."}, {"question": "Does homeowners insurance cover foundation repair?", "answer": "Rarely. Foundation damage caused by settling, soil movement, hydrostatic pressure, or gradual water intrusion is excluded from standard HO-3 policies. Earthquake damage to a foundation requires a separate earthquake endorsement. The only scenario where a standard policy might contribute to foundation-adjacent costs is if a sudden, covered peril (like a burst pipe) caused direct damage to a structural element \u2014 and even then, coverage is limited and contested."}]
...
Understanding the adjuster's framework helps you document claims correctly from the start.

Adjusters are looking for three things: the cause of loss, the timeline, and the scope of damage. They will photograph the source (the failed pipe, the appliance, the roof breach), look for evidence of how long the water was present, and assess whether the damage is consistent with the reported cause.
...
The actions you take immediately after discovering damage affect both the physical outcome and the claim outcome.

1. **Stop the source.** Shut off the supply valve at the appliance or the main shutoff. For roof damage, get a tarp on it.
