...
faq: [{"question": "How long do I have to file a storm damage insurance claim in Washington State?", "answer": "Washington State law requires insurers to acknowledge a claim within 10 business days, but your policy sets its own deadline for *filing* \u2014 commonly one year from the date of loss, though some policies are shorter. Read your declarations page carefully, and when in doubt, file sooner rather than later. A delayed claim is one of the most common reasons insurers deny coverage."}, {"question": "What if the storm damage isn't obvious right away \u2014 can I file a claim weeks later?", "answer": "Yes, but document when you first noticed the damage and what prompted you to look closer (a ceiling stain that appeared after the next rain, for example). Latent damage \u2014 like water intrusion that only becomes visible over time \u2014 is generally still claimable as long as you can tie it to a specific storm event and file within your policy's time limit. The challenge is proving the storm caused it, which is why photos and a written timeline matter even for slow-developing damage."}, {"question": "Do I need a public adjuster, or can I handle the claim myself?", "answer": "Most homeowners handle straightforward claims \u2014 a damaged fence, a few missing shingles \u2014 without a public adjuster. Where a public adjuster earns their fee (typically 10\u201315% of the settlement) is on complex, high-value claims where the insurer's initial estimate is significantly low or where there's a dispute about cause of loss. A restoration contractor who works directly with insurance companies can often serve a similar advocacy role during the estimate phase at no extra cost to you."}, {"question": "My insurer sent a check but it's made out to both me and my mortgage lender. Why, and what do I do?", "answer": "When a home has a mortgage, the lender is listed as a \"loss payee\" on the policy \u2014 meaning they have a financial interest in the property being repaired. Dual-payee checks are standard practice. You'll need to contact your mortgage servicer to endorse the check; most have a loss draft department with a specific process for releasing funds as repairs are completed. Ask your contractor if they've worked with your lender before \u2014 experienced restoration companies navigate this regularly."}]
...
Don't assume the house is fine just because it's standing. After a significant wind event, hail storm, or heavy rain, check for these before you go back inside:

- **Structural damage to the roof or walls.** If you can see daylight through the ceiling or a wall is visibly bowing, stay out and call a contractor first.
- **Downed power lines near the structure.** Even if the lines aren't touching the house, wet ground conducts electricity. Call Puget Sound Energy at 1-888-225-5773 to report and confirm it's safe.
- **Gas smell.** If you smell sulfur or rotten eggs, leave immediately, don't flip any switches, and call Puget Sound Energy's emergency line or 911.
- **Standing water inside.** Flooded basements can hide submerged electrical panels. Don't wade in until power is confirmed off at the meter.

Once you've confirmed it's safe, then you document.

## Step 2: Document Everything Before You Touch Anything

This is the single most important thing you can do for your claim. Insurance adjusters are trained to look for pre-existing conditions and to question damage that wasn't captured before cleanup began. Your phone camera is your best tool right now.
...
- The date and approximate time the storm hit your area
...
- Tarping a damaged roof section (hardware stores carry heavy-duty poly tarps; many restoration contractors will do emergency tarping same-day)
...
When you do call, ask specifically: What is the deadline to file this claim? When can I expect the adjuster? Am I entitled to an advance for emergency expenses?

## Step 5: Understand What Happens After the Adjuster Visits

The adjuster's job is to assess the damage and produce an estimate using standardized pricing software (most commonly Xactimate). That estimate becomes the insurer's opening offer. You are allowed to dispute it.

**Common reasons claims come in lower than expected:**
...
- Request a re-inspection with your own contractor present
