...
faq: [{"question": "Can I stay in my home during water damage restoration?", "answer": "In most Category 1 situations \u2014 a burst pipe, an overflowing appliance \u2014 you can stay home while drying equipment runs, though the noise from air movers is significant (roughly 65\u201370 decibels, similar to a vacuum cleaner running continuously). Category 2 or 3 water intrusions, or any situation involving mold remediation with containment barriers, may require you to temporarily relocate. Your contractor should give you a clear recommendation after the initial assessment."}, {"question": "Will my homeowner's insurance cover water damage restoration?", "answer": "Most standard homeowner's policies cover sudden and accidental water damage \u2014 a pipe that bursts, an appliance that fails \u2014 but exclude gradual leaks or flooding from outside the home (which requires separate flood insurance). The key documentation insurers want is evidence of the source, the extent of damage, and a professional scope of work. A restoration contractor who works regularly with insurance carriers can help you build that file and communicate directly with your adjuster, which often speeds up approval."}, {"question": "How do I know when drying is actually complete?", "answer": "Drying is complete when moisture meter readings across all affected materials return to pre-loss baseline levels \u2014 typically below 16% for wood and drywall, though the exact target depends on the material and the local equilibrium moisture content for your climate. \"Dry to the touch\" is not a reliable indicator; surfaces can feel dry while wall cavities still hold enough moisture to sustain mold growth. A reputable contractor will provide a final moisture log showing readings taken at multiple points before closing out the drying phase."}, {"question": "What happens if water damage isn't treated quickly enough?", "answer": "Within 24 to 48 hours, mold can begin colonizing wet drywall, wood framing, and insulation \u2014 particularly in Pacific Northwest conditions where ambient humidity is already high. After 72 hours, Category 1 water can degrade to Category 2 or 3 as bacteria multiply. Structurally, prolonged moisture exposure causes wood framing to swell, warp, and eventually rot, which turns a drying project into a partial reconstruction. The cost difference between a job addressed within hours versus one discovered days later is often measured in thousands of dollars."}]
...
**Days 2–5 (or longer) — Structural drying**
This is the phase most homeowners underestimate. Equipment runs continuously, 24 hours a day. A technician returns daily to take moisture readings and adjust equipment placement. The goal is to bring all affected materials down to pre-loss moisture levels — not just "dry to the touch." Drywall that feels dry on the surface can still read 18–22% moisture content inside the wall cavity. Anything above roughly 16% is a mold risk.
...
1. **Stop the source.** For a burst pipe, turn off the main water shutoff. For an appliance leak, pull the supply line. For a roof intrusion, get a tarp over the affected area if it's safe to do so.
2. **Remove standing water manually if you can.** Towels, a wet/dry shop vac, or a mop — anything that reduces saturation time matters. Don't use a standard household vacuum.
3. **Move furniture and belongings off wet flooring.** Upholstered furniture sitting in water becomes a secondary contamination source quickly.
4. **Open interior doors and run ceiling fans** to improve air circulation — but don't run HVAC if you suspect the system itself got wet.
5. **Document everything with photos and video** before touching anything. Your insurance claim will thank you.
